#ifndef DOGTOOTH_NODE__ODOMETRY_HPP_
#define DOGTOOTH_NODE__ODOMETRY_HPP_
...
namespace robotis
{
  namespace dogtooth
  {
    ...
    {
      public:
        explicit Odometry(std::shared_ptr<rclcpp::Node> & nh, const double wheels_separation, const double wheels_radius);
        virtual ~Odometry() {}
...
#endif  // DOGTOOTH_NODE__ODOMETRY_HPP_
